...
class AsciiEffectImpl extends Effect {
  constructor(options: AsciiEffectOptions) {
    ...
    const uniforms = new Map<string, Uniform<any>>([
      ...
      ["targetFPS", new Uniform(postfx.targetFPS ?? 22)],
      ["jitterIntensity", new Uniform(postfx.jitterIntensity ?? 0)],
      ["jitterSpeed", new Uniform(postfx.jitterSpeed ?? 7.2)],
      ...
      ["colorPalette", new Uniform(typeof postfx.colorPalette === 'number' ? postfx.colorPalette : 0)],
      ["curvature", new Uniform(postfx.curvature ?? 0)],
      ["aberrationStrength", new Uniform(postfx.aberrationStrength ?? 0)],
      ["noiseIntensity", new Uniform(postfx.noiseIntensity ?? 0.16)],
      ...
      ["brightnessAdjust", new Uniform(postfx.brightnessAdjust ?? -0.46)],
