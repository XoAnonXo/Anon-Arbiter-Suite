interface EmptyStateAsciiProps {
  title: string;
  subtitle: string;
}

// Community/People SVG Icon
const CommunityIcon = () => (
  <svg 
    viewBox="0 0 256 256" 
    fill="currentColor"
...
export function EmptyStateAscii({ title, subtitle }: EmptyStateAsciiProps) {
  return (
    <div className="empty-state-ascii">
      <CommunityIcon />
      <h3>{title}</h3>
      <p>{subtitle}</p>
    </div>
